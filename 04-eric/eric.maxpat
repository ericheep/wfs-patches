...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 188.0, 320.0, 81.0, 22.0 ],
					"text" : "loadmess -18"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 66.0, 100.0, 73.0, 22.0 ],
					"text" : "unpack i i f f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 261.5, 63.0, 208.0, 22.0 ],
					"text" : "route /env /del /notes"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 217.0, 147.0, 108.0, 22.0 ],
					"text" : "pack i 100 f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 262.5, 23.0, 97.0, 22.0 ],
					"text" : "udpreceive 6543"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 28.0, 195.0, 29.5, 22.0 ],
					"text" : "t i b"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 217.0, 62.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 297.0, 283.0, 58.0, 22.0 ],
					"text" : "wfs.scale"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 297.0, 360.0, 81.0, 22.0 ],
					"text" : "s wfs.sources"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 297.0, 244.0, 91.0, 22.0 ],
					"text" : "pack i f f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 28.0, 100.0, 29.5, 22.0 ],
					"text" : "t l l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 297.0, 324.0, 78.0, 22.0 ],
					"text" : "wfs.toSource"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 38.0, 287.0, 56.0, 22.0 ],
					"text" : "target $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 28.0, 63.0, 59.0, 22.0 ],
					"text" : "route /src"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 190.0, 139.0, 58.0, 22.0 ],
									"text" : "loadbang"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 230.5, 61.0, 29.5, 22.0 ],
									"text" : "t l l"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 241.0, 100.0, 37.0, 22.0 ],
									"text" : "zl len"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 50.0, 174.0, 56.0, 22.0 ],
									"text" : "zl lookup"
								}
...
,
					"patching_rect" : [ 217.0, 105.0, 81.0, 22.0 ],
					"text" : "p randomMidi"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 28.0, 23.0, 97.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 38.0, 349.0, 148.0, 50.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 38.0, 320.0, 128.0, 22.0 ],
					"text" : "mc.poly~ boidBeep 40"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 36.0, 632.0, 54.0, 22.0 ],
					"text" : "mc.dac~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 203.0, 435.0, 79.0, 22.0 ],
					"text" : "r wfs.sources"
				}
...
,
					"patching_rect" : [ 307.0, 523.0, 89.0, 22.0 ],
					"text" : "p spat5Options"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 66.0, 435.0, 121.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "multichannelsignal", "", "float", "list" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 36.0, 560.0, 420.0, 52.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 66.0, 471.0, 353.0, 22.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
					"text" : "spat5.viewer @initwith \"/source/number 40, /speaker/number 64\"",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "multichannelsignal", "" ],
					"patching_rect" : [ 36.0, 523.0, 263.0, 22.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
					"text" : "spat5.wfs~ @sources 40 @speakers 64 @mc 1"
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-17" : [ "mc.live.gain~[2]", "mc.live.gain~[2]", 0 ],
...
,
		"dependency_cache" : [ 			{
				"name" : "boidBeep.maxpat",
				"bootpath" : "~/git/wfs-patches/04-eric",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
