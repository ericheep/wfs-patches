...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 602.5, 605.0, 285.0, 61.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 675.5, 562.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 602.5, 562.0, 60.0, 22.0 ],
					"text" : "mc.*~ 0.1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "int", "", "", "int" ],
					"patching_rect" : [ 602.5, 431.0, 75.0, 22.0 ],
					"text" : "counter 1 12"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 602.5, 237.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 602.5, 303.0, 43.0, 22.0 ],
					"text" : ">~ 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 602.5, 344.0, 42.0, 22.0 ],
					"text" : "edge~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 602.5, 273.0, 66.0, 22.0 ],
					"text" : "phasor~ 1."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 602.5, 391.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 468.0, 330.0, 81.0, 22.0 ],
					"text" : "s wfs.sources"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "int" ],
					"patching_rect" : [ 602.5, 480.0, 29.5, 22.0 ],
					"text" : "t b i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 646.5, 480.0, 56.0, 22.0 ],
					"text" : "target $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 602.5, 526.0, 141.0, 22.0 ],
					"text" : "mc.poly~ polyImpulse 12",
					"varname" : "poly~_AA"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 468.0, 193.0, 29.5, 22.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 468.0, 254.0, 53.0, 22.0 ],
					"text" : "pack i f f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 468.0, 293.0, 78.0, 22.0 ],
					"text" : "wfs.toSource"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 468.0, 146.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 611.0, 146.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 468.0, 102.0, 162.0, 22.0 ],
					"text" : "unpack i f f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 468.0, 65.0, 59.0, 22.0 ],
					"text" : "route /src"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 468.0, 31.0, 97.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 192.5, 490.0, 79.0, 22.0 ],
					"text" : "r wfs.sources"
				}
...
,
					"patching_rect" : [ 327.0, 562.0, 89.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 55.5, 526.0, 360.0, 22.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
					"text" : "spat5.viewer @initwith \"/source/number 100, /speaker/number 64\"",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "multichannelsignal", "" ],
					"patching_rect" : [ 55.5, 562.0, 269.0, 22.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
					"text" : "spat5.wfs~ @sources 100 @speakers 64 @mc 1"
				}
...
, 			{
		...
		"originid" : "pat-1426",
		"parameters" : 		{
			"obj-101" : [ "mc.live.gain~[1]", "mc.live.gain~[1]", 0 ],
...
,
		"dependency_cache" : [ 			{
				"name" : "polyImpulse.maxpat",
				"bootpath" : "~/Desktop/eric-l",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
